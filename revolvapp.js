...
(function() {
    ...
    Revolvapp.add('module', 'tidy', {
        ...
        parse: function(code, type) {
            ...
            if (type === 'html') {
                newLevel = ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'title', 'head', 'body', 'table', 'thead', 'tbody', 'tfoot', 'tr', 'td', 'th'];
            }
    ...
    Revolvapp.add('class', 'tag.list', {
        ...
        create: function() {
            ...
            this.$element.css({ 'margin': 0, 'padding': 0, 'font-family': this.getStyle('text', 'font-family') });
        },
        build: function() {
            this.params = {
